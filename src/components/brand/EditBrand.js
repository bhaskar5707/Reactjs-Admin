...
export default class AddBrand extends React.Component {
	...
	componentDidMount() {
      ...
      axios.get('http://localhost/react-ci/index.php/edit-brand/'+this.props.match.params.id)
          .then(response => {
              this.setState({ 
                brand_name: response.data.name});
	...
	onSubmit(e) {
        ...
        if(this.state.brand_name)
	    {
		    ...
		    axios.post('http://localhost/react-ci/index.php/update-brand/'+this.props.match.params.id, obj)
		        .then(res => console.log(res.data));
		    this.props.history.push('/edit-brand/'+this.props.match.params.id);
		    this.setState({
